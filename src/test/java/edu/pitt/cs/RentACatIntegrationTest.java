...
public class RentACatIntegrationTest {
	...
	public void setUp() throws Exception {
		...
		// Note for Drake from David: I made these cat objects real since if it's an integration test, I think we gotta check
		// real objects to see how the cat classes that we made actually "integrate" with the rental cat class we also made
	 ...
	 */
	@Test
	public void testGetCatNullNumCats0() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		// TODO: Fill in
